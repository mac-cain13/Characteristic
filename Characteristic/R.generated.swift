...
struct R {
  static func validate() {
    storyboard.configurator.validateImages()
    storyboard.configurator.validateViewControllers()
  }
  ...
  struct reuseIdentifier {
    static var choiceCell: ReuseIdentifier<UITableViewCell> { return ReuseIdentifier(identifier: "ChoiceCell") }
    static var multipleChoiceCell: ReuseIdentifier<MultipleChoiceCell> { return ReuseIdentifier(identifier: "MultipleChoiceCell") }
  }
  
  struct segue {
    static var presentCharacteristicChoices: String { return "PresentCharacteristicChoices" }
    static var unwindFromMultipleChoicePickerToConfigurator: String { return "UnwindFromMultipleChoicePickerToConfigurator" }
  }
  ...
  struct storyboard {
    struct configurator {
      ...
      static var instance: UIStoryboard { return UIStoryboard(name: "Configurator", bundle: _R.hostingBundle) }
...
struct _R {
  static var hostingBundle: NSBundle? { return NSBundle(identifier: "nl.mathijskadijk.characteristic") }
